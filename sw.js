const APP_CACHE_NAME = 'test-communes-app-cache-v891'; 
const DATA_CACHE_NAME = 'test-communes-data-cache-v891';
const TILE_CACHE_NAME = 'test-communes-tile-cache-v891';
...
self.addEventListener('fetch', event => {
    if (IS_SAFARI_SW) {
        // Fallback robuste Safari: laisser le navigateur gérer le réseau directement.
        return;
    }
