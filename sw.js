const APP_CACHE_NAME = 'communes-app-cache-v54.7'; // Version 54.7
const DATA_CACHE_NAME = 'communes-data-cache-v54.7';
const TILE_CACHE_NAME = 'communes-tile-cache-v54.7';
