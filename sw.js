const APP_CACHE_NAME = 'communes-app-cache-v55.1'; // Version 55.1
const DATA_CACHE_NAME = 'communes-data-cache-v55.1';
const TILE_CACHE_NAME = 'communes-tile-cache-v55.1';
