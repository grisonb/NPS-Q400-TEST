const APP_CACHE_NAME = 'communes-app-cache-v54.4'; // Version 54.4
const DATA_CACHE_NAME = 'communes-data-cache-v54.4';
const TILE_CACHE_NAME = 'communes-tile-cache-v54.4';
